...
const WeaponSub3: ReadonlyRecord<ItemBonusType, ReadonlyArray<number>> = {
...
const WeaponSub4: ReadonlyRecord<ItemBonusType, ReadonlyArray<number>> = {
    //         1, 20, 40, 50, 60, 70, 80, 90
...
const WeaponSub5: ReadonlyRecord<ItemBonusType, ReadonlyArray<number>> = {
    //         1, 20, 40, 50, 60, 70, 80, 90
    "hp_buf": [],
...
const SwordList: ReadonlyRecord<typeof SwordNames[number], IWeapon> = {
    ...
    LionsRoar: {
        ...
        passive: { items: AnyBonusType.Damage, value: [20, 24, 28, 32, 36], limit: "炎、雷元素の影響を受けた敵" },
    },
    TheFlute: {
        star: 4,
        atk: WeaponAtk4[42],
    ...
    AlleyFlash: {
        ...
        passive: { items: AnyBonusType.Damage, value: [12, 15, 18, 21, 24] },
    },
    RoyalLongsword: {
        star: 4,
        atk: WeaponAtk4[42],
    ...
    IronSting: {
        ...
        passive: { items: AnyBonusType.Damage, value: [6, 7.5, 9, 10.5, 12], limit: "元素ダメージを与えた後", times: 6, stack: 2 },
    },
    SwordDescension: {
        star: 4,
        atk: WeaponAtk4[39],
    ...
    CoolSteel: {
        ...
        passive: { items: AnyBonusType.Damage, value: [12, 15, 18, 21, 24], limit: "水、氷元素の影響を受けた敵" },
    },
    DarkIronSword: {
        star: 3,
        atk: WeaponAtk3[39],
...
const ClaymoreList: ReadonlyRecord<typeof ClaymoreNames[number], IWeapon> = {
    ...
    SkywardPride: {
        ...
        secval: [8.0, 14.1, 20.6, 23.8, 27.1, 30.3, 33.5, 36.8],
        // 与えるダメージ+8~16%。
        passive: { items: AnyBonusType.Damage, value: [8, 10, 12, 14, 16] },
    ...
    Rainslasher: {
        ...
        passive: { items: AnyBonusType.Damage, value: [20, 24, 28, 32, 36], limit: "水、雷元素の影響を受けた敵" },
    },
    TheBell: {
        star: 4,
        atk: WeaponAtk4[42],
        ...
        passive: { items: AnyBonusType.Damage, value: [12, 15, 18, 21, 24], limit: "シールドが存在する時" },
    },
    LithicBlade: {
        star: 4,
        atk: WeaponAtk4[42],
    ...
    SerpentSpine: {
        ...
        passive: { items: AnyBonusType.Damage, value: [6, 7, 8, 9, 10], limit: "フィールドにいる時4秒毎", stack: 5 },
    },
    SnowTombedStarsilver: {
        star: 4,
        atk: WeaponAtk4[44],
    ...
    BloodtaintedGreatsword: {
        ...
        passive: { items: AnyBonusType.Damage, value: [12, 15, 18, 21, 24], limit: "炎、雷元素の影響を受けた敵" },
    },
    FerrousShadow: {
        star: 3,
        atk: WeaponAtk3[39],
...
const PolearmList: ReadonlyRecord<typeof PolearmNames[number], IWeapon> = {
    PrimordialSpear: {
        ...
        passive: [
            ...
            { items: AnyBonusType.Damage, value: [12, 15, 18, 21, 24], limit: "さらに7重まで発動した時" },
        ],
    },
    SkywardSpine: {
        star: 5,
    ...
    DragonsBane: {
        ...
        passive: { items: AnyBonusType.Damage, value: [20, 24, 28, 32, 36], limit: "水、炎元素の影響を受けた敵" },
    },
    LithicSpear: {
        star: 4,
        atk: WeaponAtk4[44],
    ...
    BlackTassel: {
        ...
        passive: { items: AnyBonusType.Damage, value: [40, 50, 60, 70, 80], limit: "スライムタイプの敵" },
    },
    Halberd: {
        star: 3,
        atk: WeaponAtk3[40],
...
const BowList: ReadonlyRecord<typeof BowNames[number], IWeapon> = {
    ...
    SharpshootersOath: {
        ...
        secval: WeaponSub3.cri_dmg,
        // 弱点に対するダメージ+24~48%。
        passive: { items: AnyBonusType.Damage, value: [24, 30, 36, 42, 48], limit: "弱点" },
    },
    RavenBow: {
        star: 3,
        atk: WeaponAtk3[40],
        ...
        passive: { items: AnyBonusType.Damage, value: [12, 15, 18, 21, 24], limit: "水、炎元素の影響を受けた敵" },
    },
    Slingshot: {
        star: 3,
        atk: WeaponAtk3[38],
...
const CatalystList: ReadonlyRecord<typeof CatalystNames[number], IWeapon> = {
    SkywardAtlas: {
        ...
        // 元素ダメージ+12~24%。
        passive: { items: AnyBonusType.Element, value: [12, 15, 18, 21, 24] },
    ...
    LostSacredWinds: {
        ...
        passive: { items: AnyBonusType.Element, value: [8, 10, 12, 14, 16], limit: "出場中は4秒毎", stack: 4 },
    },
    MemoryDust: {
        star: 5,
        atk: WeaponAtk5[46],
    ...
    TheWidsith: {
        ...
        passive: [
            ...
            // 詠唱:全元素ダメージ+48~96%
            { items: AnyBonusType.Element, value: [48, 60, 72, 84, 96], limit: "詠唱：キャラ登場時", times: 10 },
            // 間奏曲:元素熟知+240~480%
    ...
    MappaMare: {
        ...
        passive: { items: AnyBonusType.Element, value: [8, 10, 12, 14, 16], limit: "元素反応を起こした後", times: 10, stack: 2 },
    },
    SolarPearl: {
        star: 4,
        atk: WeaponAtk4[42],
    ...
    MagicGuide: {
        ...
        passive: { items: AnyBonusType.Damage, value: [12, 15, 18, 21, 24], limit: "水、雷元素の影響を受けた敵" },
    },
    TalesDragonSlayers: {
        star: 3,
        atk: WeaponAtk3[39],
...
export const WeaponNames: ReadonlyRecord<WeaponType, ReadonlyArray<string>> = {
    sword: SwordNames,
...
export const WeaponList: ReadonlyRecord<WeaponType, WeaponList> = {
    sword: SwordList,
