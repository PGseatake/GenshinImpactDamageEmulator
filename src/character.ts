            ...
            asc1st: [
                {
                    ...
                    value: 16,
                    limit: "アーロイが凍てついた大地のコイル効果を獲得した時",
                    times: 10,
                },
                {
                    items: konst.FlatBonusDest.AtkBuf,
    ...
    Beidou: {
        ...
        passive: {
            ...
            asc4th: {
                ...
                value: 15.0,
                limit: "最大ダメージ上昇効果のある元素スキルを発動した時",
                times: 10,
            },
        },
        conste: {
    ...
    Keqing: {
        ...
        conste: {
            ...
            lv6: {
                ...
                value: 6.0,
                limit: "通常攻撃、重撃、元素スキルまたは元素爆発を発動する時",
                times: 8,
            },
    ...
    Sangonomiya: {
        ...
        conste: {
            ...
            lv6: {
                items: konst.ElementBonusType.Hydro,
                value: 40,
                limit: "通常攻撃または重撃でHP80%以上のキャラクターに治療をした時",
                times: 4,
            },
        }
    },
