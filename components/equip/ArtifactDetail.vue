...
export default class ArtifactDetail extends Vue {
  ...
  get main() {
    return this.$formatBonus(this.item?.main);
  }

  get sub1() {
    return this.$formatBonus(this.item?.sub1);
  }

  get sub2() {
    return this.$formatBonus(this.item?.sub2);
  }

  get sub3() {
    return this.$formatBonus(this.item?.sub3);
  }

  get sub4() {
    return this.$formatBonus(this.item?.sub4);
  }
}
</script>
